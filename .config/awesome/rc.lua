...
beautiful.wallpaper = awful.util.get_configuration_dir() .. "/themes/zenburn/bg.png"
...
local menu_awesome = { "awesome", myawesomemenu, beautiful.awesome_icon } -- list name, list content, list icon
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "g", awful.tag.history.restore,
    ...
    awful.key({ modkey,           }, "b", function () awful.spawn("firefox") end,
              {description = "open chrome", group = "client"}),
    ...
    awful.key({ modkey }, "p", function() awful.spawn("rofi -show drun") end,
              {description = "show the rofi app menu", group = "launcher"}),
